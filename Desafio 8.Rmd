...
sql <- "
SELECT 
  (a_count*4 + ab_count*3.5 + b_count*3 + bc_count*2.5 + c_count*2 + d_count*1 + f_count*0) / 
  (a_count + ab_count + b_count + bc_count + c_count + d_count + f_count) AS MEDIAS
...
```
```{r}
#3.1(Professor mais difícil e  mais fácil)
...
```{r}
#3.2(Disciplina mais difícil e mais fácil)
